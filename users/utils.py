...
class EmailUtil:
    ...
    def send_email(data, url, html):
        context = {"link_app": "".join(url) + data["token"]}
        html_content = render_to_string(html, context=context)
...
class LengthValidator:
    ...
    def validate(self, password, user=None):
        ...
        if len(password) > self.max_length:
            raise ValidationError(
                _(
                    "The password's length must be lower than %(max_length)d characters."
                ),
    ...
    def get_help_text(self):
        return _(
            ...
            % {"min_length": self.min_length, "max_length": self.max_length + 1}
        )
...
class DigitValidator:
    ...
    def get_help_text(self):
        return _("Your password must contain numeric character.")
...
class UpperLowerValidator:
    ...
    def get_help_text(self):
        return _("Your password must contain upper case and lower case characters.")
...
class SpecialCharacterValidator:
    ...
    def get_help_text(self):
        return _("Your password must contain special characters.")
